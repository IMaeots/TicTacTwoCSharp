...
public class GameRepositoryJson : IGameRepository
{
    ...
    public void SaveNewGame(GameLogic.Game game)
    {
        ...
        if (!File.Exists(configFilePath)) throw new InvalidOperationException($"Configuration '{game.Configuration.Name}' does not exist.");
    ...
    public void DeleteGame(GameLogic.Game game)
    {
        ...
        if (!File.Exists(filePath))
        {
            throw new FileNotFoundException($"Game '{game.Name}' does not exist.", filePath);
        }
    ...
    {
        var configuration = JsonSerializer.Deserialize<GameConfiguration>(jsonConfiguration);
    ...
    {
        var state = JsonSerializer.Deserialize<GameState>(jsonGameState);
        if (state == null)
        {
